...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
			...
			['Necky',				'sirox',		'Optimized All The Sprites',	'https://youtube.com/channel/UCBd_G_wH1lBDlh6j9M93DnA',	'0xFF61536A'],
			['Nichistuff',				'nichijou',		'Wanna See The BGM of Nichijou? well click here',	'https://twitter.com/bluethebone?s=20&t=0bqZg6mzPiziwYFEcWanBQ',	'0xFF61536A'],
			[''],
			["Funkin' Crew"],
